    ...
    const slides = [
        {
            ...
            img: "https://images.pexels.com/photos/26729111/pexels-photo-26729111/free-photo-of-back-view-of-a-woman-in-an-academic-dress.jpeg?auto=compress&cs=tinysrgb&w=600",
            url: "/",
  ...
  return (
      <div className="h-[calc(100vh-80px)] overflow-hidden">
          ...
          <div className="absolute m-auto left-1/2 bottom-8 flex gap-4">
                            {
                  slides.map((slide, index)=>(
                      <div className={`w-3 h-3 rounded-full ring-1 ring-gray-600 cursor-pointer flex items-center justify-center ${current === index ? "sacle-150" : ""}`} key={slide.id} onClick={()=>setCurrent(index)}>
                          {current === index && (
